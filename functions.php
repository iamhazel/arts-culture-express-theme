...
function pn_enqueue_style() {      
        wp_enqueue_style('theme-styles', get_template_directory_uri() . '/assets/css/styles.css', array(), null, false);            
        wp_enqueue_style('main-style', get_template_directory_uri() . '/style.css');
        wp_enqueue_style('bootstrap', 'https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-alpha3/dist/css/bootstrap.min.css');
}
...
function pn_enqueue_script(){
        ...
        wp_enqueue_script('main-js', get_template_directory_uri() . '/assets/dist/js/js.dist.js', '', '1.0.0', true);
        wp_enqueue_script('bootstrap-js', 'https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-alpha3/dist/js/bootstrap.bundle.min.js');
...
if (!function_exists('loop_columns')) {
	function loop_columns() {
		return 1; // X products per row
	}
}

/**
 * Print template-in-use on each page
 */
